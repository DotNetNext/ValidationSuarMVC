...
public partial class demo1_V1 : System.Web.UI.Page
{
    private string _pageKey = "v1.aspx";
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ////MVC中可以使用ViewBag 扔到body最下面 ，可以使用变量，这里只是测试不考虑性能
            //ViewState["initscript"] = ValidationSugar.GetInitScript(_pageKey, new List<ValidationSugar.OptionItem>()
            //    {
